...
from python_qt_binding.QtWidgets import QSizePolicy, QGraphicsView,QGraphicsAnchorLayout,QGraphicsScene,QToolTip
from python_qt_binding.QtWidgets import QGraphicsWidget
